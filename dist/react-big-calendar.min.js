!(function(e, t) {
  ...
  function Ut(e, t) {
    var n = '',
      r = ''
    if ('string' == typeof t)
      return e.style.getPropertyValue(Wt(t)) || Lt(e).getPropertyValue(Wt(t))
  ...
  function Gt(e) {
    ...
    return r && Vt(r, e)
      ? (void 0 !== e.getBoundingClientRect && (n = e.getBoundingClientRect()),
        (n = {
          top: n.top + $t(r) - (r.clientTop || 0),
          left: n.left + Kt(r) - (r.clientLeft || 0),
          width: n.width,
          height: n.height,
        }))
      : n
  ...
  function Zt(e, t) {
    ...
    if ('fixed' === Ut(e, 'position')) n = e.getBoundingClientRect()
      ...
      var o =
        ...
        (function(e) {
          for (
            var t = Rt(e), n = e && e.offsetParent;
            Xt(n) && 'HTML' !== n.nodeName && 'static' === Ut(n, 'position');

          )
            n = n.offsetParent
          return n || t.documentElement
        })(e)
      ;(n = Gt(e)), 'html' !== qt(o) && (r = Gt(o))
      var i = String(Ut(o, 'borderTopWidth') || 0)
      r.top += parseInt(i, 10) - $t(o) || 0
      var s = String(Ut(o, 'borderLeftWidth') || 0)
      r.left += parseInt(s, 10) - Kt(o) || 0
    }
      ...
      return (
        ...
        (t.prototype.render = function() {
          ...
          var D = m.title(o),
            ...
            T = m.start(o),
            x = m.allDay(o),
            N = c || x || Ke(T, Ue(O, 'day'), 'day') > 1,
            j = v.eventProp(o, T, O, i),
            P = r.createElement(
              'div',
    ...
    return (
      (n.componentDidMount = function() {
        var e,
          ...
          r = n.popupOffset,
          o = void 0 === r ? 5 : r,
          i = Gt(n.popperRef.current),
          a = i.top,
          s = i.left,
          c = i.width,
          l = i.height,
          u = window.innerHeight + $t(window),
          f = window.innerWidth + Kt(window),
          p = a + l,
          d = s + c
        ;(p > u || d > f) &&
          (p > u && (e = p - u + (o.y || +o || 0)),
  ...
  function An(e) {
    return Cn({}, e, { right: e.left + e.width, bottom: e.top + e.height })
  }
  function Fn(e) {
    var t = {}
    try {
  ...
  function Wn(e, t, n) {
    ...
    return Rn(n, r ? Ln(t) : Mn(t, bn(n)), r)
  }
  function Hn(e) {
  ...
  function Xn(e, t, n, r) {
    ;(n.updateBound = r),
      Gn(e).addEventListener('resize', n.updateBound, { passive: !0 })
    var o = yn(e)
    return (
      (function e(t, n, r, o) {
  ...
  function qn() {
    ...
    this.state.eventsEnabled &&
      ...
      (this.state =
        ((e = this.reference),
        (t = this.state),
        Gn(e).removeEventListener('resize', t.updateBound),
  ...
  var ar = {
      ...
      modifiers: {
          ...
          fn: function(e) {
            ...
            if (r) {
              var o = e.offsets,
                ...
                u = {
                  start: kn({}, c, i[c]),
                  end: kn({}, c, i[c] + i[l] - a[l]),
                }
              e.offsets.popper = Cn({}, a, u[r])
            }
            return e
          },
        },
        ...
        flip: {
          ...
          enabled: !0,
          fn: function(e, t) {
            if (Kn(e.instance.modifiers, 'inner')) return e
        ...
        computeStyle: {
          ...
          fn: function(e, t) {
            ...
            return (
              (e.attributes = Cn({}, y, e.attributes)),
              (e.styles = Cn({}, l, e.styles)),
              (e.arrowStyles = Cn({}, e.offsets.arrow, e.arrowStyles)),
              e
            )
          },
          gpuAcceleration: !0,
    ...
    sr = (function() {
      function e(t, n) {
        ...
        jn(this, e),
          ...
          (this.options = Cn({}, e.Defaults, o)),
          (this.state = { isDestroyed: !1, isCreated: !1, scrollParents: [] }),
          (this.reference = t && t.jquery ? t[0] : t),
          (this.popper = n && n.jquery ? n[0] : n),
          (this.options.modifiers = {}),
          Object.keys(Cn({}, e.Defaults.modifiers, o.modifiers)).forEach(
            function(t) {
              r.options.modifiers[t] = Cn(
                {},
          ...
          (this.modifiers = Object.keys(this.options.modifiers)
            .map(function(e) {
              return Cn({ name: e }, r.options.modifiers[e])
            })
            .sort(function(e, t) {
  ...
  function wr(e, n, r) {
    ...
    t.useEffect(
      function() {
        if (!a && null != e) {
          var t,
            n = ((t = e.current), Rt(o.findDOMNode(t))),
            r = vr(n, c, f, !0),
            i = vr(n, c, p),
            s = vr(n, 'keyup', d),
            l = []
  ...
  function Dr(e, t) {
    var n = Bt(e)
    return n ? n.innerHeight : t ? e.clientHeight : Gt(e).height
  }
  ;(Sr.displayName = 'Overlay'),
    (Sr.propTypes = {
      show: z.bool,
      placement: z.oneOf(sr.placements),
      target: z.any,
      container: z.any,
      flip: z.bool,
  ...
  var kr = (function() {
    ...
    return (
      ...
      (t.isSelected = function(e) {
        ...
        return !(!t || !this.selecting) && Cr(t, Ar(e))
      }),
      (t.filter = function(e) {
  ...
  ;(Wr.propTypes = {}), (Wr.defaultProps = a({}, Lr))
  ...
  var Br,
    ...
    Kr = (Br = /[^.]+$/.exec((Yr && Yr.keys && Yr.keys.IE_PROTO) || ''))
      ? 'Symbol(src)_1.' + Br
      : ''
  ...
  function to(e) {
    return (
      !(!ct(e) || ((t = e), Kr && Kr in t)) && (dt(e) ? eo : Xr).test(Gr(e))
    )
    var t
  }
  function no(e, t) {
  ...
  var Go = Object.prototype,
    Xo = Go.hasOwnProperty,
    qo = Go.propertyIsEnumerable,
    Zo = $o(
      (function() {
        return arguments
      })()
      ...
      ? $o
      : function(e) {
          return Et(e) && Xo.call(e, 'callee') && !qo.call(e, 'callee')
        }
  ...
  var oi = 'object' == typeof e && e && !e.nodeType && e,
    ...
    ai = ii && ii.exports === oi && Xe.process,
    si = (function() {
      try {
  ...
  function Li(e, t, n, r, o, i) {
    ...
    if (!(n & ki)) {
      var d = u && Ri.call(e, '__wrapped__'),
        h = f && Ri.call(t, '__wrapped__')
      if (d || h) {
        var m = d ? e.value() : e,
          v = h ? t.value() : t
            ...
            (function(e, t, n, r) {
              ...
              for (; ++o < i; ) {
                ...
                if (a && s[2]) {
                  ...
                  if (!(void 0 === p ? Ii(u, l, zi | Wi, r, f) : p)) return !1
                }
              }
              return !0
            })(n, e, t)
  ...
  function Gi(e, t) {
    ...
    return (n.cache = new (Gi.Cache || fo)()), n
  }
  Gi.Cache = fo
  var Xi = 500
  var qi,
      ...
      return (
        ...
        (function(e, t, n, r) {
          for (
            ...
            (a[r ? i : ++o] = e), (e += n)
          return a
        })(e, t, (n = void 0 === n ? (e < t ? 1 : -1) : kt(n)), xa)
      )
    },
    ja = function(e, t) {
          ...
          for (
            ...
            if (u) {
              ...
              if (this.canRenderSlotEvent(f, d)) {
                ...
                h && s.push(zr(n, h, c + '_gap')),
                  s.push(zr(n, d, c, m)),
                  (a = i = p + 1)
              } else
                h && s.push(zr(n, h, c + '_gap')),
                  s.push(zr(n, 1, c, this.renderShowMore(t, i))),
                  (a = i += 1)
            } else i++
          }
  ...
  ;(ka.propTypes = {}), (ka.defaultProps = a({}, Lr))
  var Fa = function(e, t) {
      return e.left <= t && e.right >= t
    },
    Ra = function(e, t) {
        ...
        return r.createElement(
          ...
          r.createElement(
            ...
            r.createElement(
              ...
              a({ isAllDay: S }, N),
              O.map(function(e, t) {
                return r.createElement(Wr, a({ key: t, segments: e }, N))
              }),
              !!T.length &&
                r.createElement(
                  ka,
        ...
        return (
          ...
          (t.renderWeek = function(e, n) {
            var o = t.props,
              ...
              g = m.rowLimit
            return (
              (i = Wa(i, e[0], e[e.length - 1], d)).sort(function(e, t) {
                return Ma(e, t, d)
              }),
              r.createElement(La, {
                key: n,
          ...
          (t.readerDateHeading = function(e) {
            var n = e.date,
              ...
              v = t.props.components.dateHeader || za
            return r.createElement(
              'div',
              a({}, i, {
      ...
      return (
        ...
        (o.render = function() {
          var e = this.props,
            ...
            o = e.className,
            i = (function(e, t, n) {
              t = (n ? wt(e, t, n) : void 0 === t) ? 1 : Ft(Ct(t), 0)
              var r = null == e ? 0 : e.length
              if (!r || t < 1) return []
              for (var o = 0, i = 0, a = Array(At(r / t)); o < r; )
                a[i++] = $e(e, o, (o += t))
              return a
            })(
              (function(e, t) {
                for (var n = We(e, t), r = He(e, t), o = []; Me(n, r, 'day'); )
  ...
  var Ka = Je ? Je.isConcatSpreadable : void 0
  function $a(e) {
    return Wo(e) || Zo(e) || !!(Ka && e && e[Ka])
  }
      ...
      return (
        ...
        (t._selectable = function() {
          var e = n.findDOMNode(re(t)),
            ...
            i = function(n) {
              var r = t.slotMetrics.closestSlotFromPoint(n, Ar(e))
  ...
  function Es(e, t) {
    var n = Bt(e)
    return n ? n.innerWidth : t ? e.clientWidth : Gt(e).width
  }
  function _s(e) {
    if (((!bs && 0 !== bs) || e) && Jt) {
    ...
    return (
      ...
      (n.render = function() {
        var e = this,
          ...
          w = t.resizable,
          E = {}
        m && (E[o ? 'marginLeft' : 'marginRight'] = _s() + 'px')
  ...
  var Os = (function(e) {
    function t(t) {
      ...
      return (
        ...
        (o.memoizedResources = Aa(function(e, t) {
          return (function(e, t) {
            return {
              map: function(n) {
                return e
  ...
  ;(Ps.propTypes = {}),
    ...
    (Cs.propTypes = {}),
    (Cs.defaultProps = { length: 30 }),
    (Cs.range = function(e, t) {
      var n = t.length
      return {
        start: e,
        end: ge(e, void 0 === n ? Cs.defaultProps.length : n, 'day'),
      }
    }),
    (Cs.navigate = function(e, t, n) {
      var r = n.length,
        o = void 0 === r ? Cs.defaultProps.length : r
      switch (t) {
        case X.PREVIOUS:
          return ge(e, -o, 'day')
        case X.NEXT:
    ...
    (Cs.title = function(e, t) {
      var n = t.length,
        r = void 0 === n ? Cs.defaultProps.length : n,
        o = t.localizer,
        i = ge(e, r, 'day')
  ...
  function Ws(e, t, n) {
    var r = e[t]
    ;(zs.call(e, t) && Ge(r, n) && (void 0 !== n || t in e)) || Is(e, t, n)
  }
  function Hs(e, t, n, r) {
    var o = !n
    n || (n = {})
    for (var i = -1, a = t.length; ++i < a; ) {
      ...
      void 0 === c && (c = e[s]), o ? Is(n, s, c) : Ws(n, s, c)
    }
    return n
  }
  ...
  var Ys = 'object' == typeof e && e && !e.nodeType && e,
    ...
    $s = Ks && Ks.exports === Ys ? Ze.Buffer : void 0,
    Gs = $s ? $s.allocUnsafe : void 0
  var Xs = hi(Object.getPrototypeOf, Object),
    qs = Object.getOwnPropertySymbols
      ? function(e) {
          for (var t = []; e; ) zo(t, Yo(e)), (e = Xs(e))
          return t
        }
      : Uo
  function Zs(e) {
    ...
    i.set(e, a),
      jc(e)
        ? e.forEach(function(r) {
            a.add(zc(r, t, n, r, e, i))
          })
        : Tc(e) &&
          e.forEach(function(r, o) {
            a.set(o, zc(r, t, n, o, e, i))
          })
    var h = l ? (c ? Zs : yi) : c ? keysIn : gi,
      m = u ? void 0 : h(e)
    return (
      Ls(m || e, function(r, o) {
        m && (r = e[(o = r)]), Ws(a, o, zc(r, t, n, o, e, i))
      }),
      a
    )
  }
  function Wc(e, t) {
    return (
      null ==
        (e = (function(e, t) {
          return t.length < 2 ? e : ua(e, $e(t, 0, -1))
        })(e, (t = sa(t, e)))) ||
      delete e[
  ...
  ;(Ic[Ac] = Ic['[object Array]'] = Ic['[object ArrayBuffer]'] = Ic[
    '[object DataView]'
    ...
    (Ic['[object Error]'] = Ic[Fc] = Ic['[object WeakMap]'] = !1)
  ...
  function $c(e) {
    return (function(e) {
      ...
      return 'function' == typeof n && n instanceof n && Bc.call(n) == Kc
    })(e)
      ? void 0
      : e
  }
  function Gc(e) {
    return (null == e ? 0 : e.length) ? Ga(e, 1) : []
  }
  var Xc = (function(e) {
      return ss(ts(e, void 0, Gc), e + '')
    })(function(e, t) {
      var n = {}
      if (null == e) return n
      var r = !1
    ...
    Jc = cs(function(e, t) {
      ...
      for (o && wt(t[0], t[1], o) && (r = 1); ++n < r; )
        for (var i = t[n], a = Bs(i), s = -1, c = a.length; ++s < c; ) {
          var l = a[s],
            u = e[l]
          ;(void 0 === u || (Ge(u, qc[l]) && !Zc.call(e, l))) && (e[l] = i[l])
        }
      return e
    })
  var Qc = function(e) {
      ...
      return (
          ...
          return Array.isArray(o)
            ? (function(e, t, n) {
                ...
                if (((t = ya(t)), null == n)) {
                  ...
                  n = o ? (r ? new i() : []) : ct(e) && dt(i) ? Dc(Xs(e)) : {}
                }
                return (
                  (o ? Ls : qa)(e, function(e, r, o) {
                    return t(n, e, r, o)
                  }),
                  n
                )
        ...
        (t.handleNavigate = function(e, n) {
          var r = t.props,
            ...
            p = c()
          l(
            (i = Fs(f, a({}, u, { action: e, date: n || i || p, today: p }))),
            o,
            e
          ),
